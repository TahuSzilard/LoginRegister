...
<body>
    <div class="mainBody">
      <div class="container">
      <div class="content">
         <h1>Üdvözöljük az oldalunkon, <span>szerkesztő</span></h1>
...
<div class="kiiratas newData">
        <form action="setupDatabase.php" method="post">
            ...
            <div id="form" style="display: none;">
                <form id="newDataForm" action="addSz.php" method="post">
...
if(isset($_POST['storeName'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<table border='1'>";
        echo "<tr><th>Termék neve</th><th>Cím</th><th>Polc</th><th>Oszlop</th><th>Sor</th><th>Bolt</th><th>Minimális mennyiség</th><th>Jelenlegi mennyiség</th><th>Ár</th><th>Módosítás</th><th>Kevés termék</th></tr>";
        while($row = $result->fetch_assoc()) {
            echo "<tr>";
            ...
            echo "<td><p><form method='get' action='modify_productSz.php'>
