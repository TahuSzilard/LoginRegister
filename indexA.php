...
<body>
    <div class="mainBody">
      <div class="container">
      <div class="content">
         <h1>Üdvözöljük az oldalunkon, <span>kedves Admin</span></h1>
...
<div class="kiiratas newData">
        <form action="setupDatabase.php" method="post">
            ...
            <div id="form" style="display: none;">
                <form id="newDataForm" action="addA.php" method="post">
...
if(isset($_POST['storeName'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo "<td><p><form method='get' action='modify_productA.php'>
